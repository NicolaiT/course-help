...
_start:
	...
	movq $9, %rax # assign 9 to RAX register
	movq $1, %rcx # assign 1 to RCX register
	movq $1, %rbx # assign 1 to RBX register
loopStart: # loop start
	cmpq %rax, %rcx 
	jg loopEnd # jump if RAX < RCX 
	imulq %rcx, %rbx # RBX *= RCX
	addq $1, %rcx # RCX += 1
	jmp loopStart # jump to start
loopEnd:
	movq %rbx, %rax # assign RBX value to RAX register
